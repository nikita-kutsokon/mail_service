...
const staticPlaceholderHandlers = {
    ...
    '%EQ_SELECTED_DATE_TYME%': (contactData) => eqSelectedDateTimePlaceholderReplacer(contactData),
};
...
const eqSelectedDateTimePlaceholderReplacer = (contactData) => {
    return (0, moment_1.default)(contactData.eduQuestSelectedDateTime).format('MMMM D, YYYY HH:mm');
};
