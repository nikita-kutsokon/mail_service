...
const staticPlaceholderHandlers = {
    ...
    '%EQ_SELECTED_DATE_TIME%': (contactData: Contact) => eqSelectedDateTimePlaceholderReplacer(contactData),
};
...
const eqSelectedDateTimePlaceholderReplacer = (contactData: Contact) => {
    return moment(contactData.eduQuestSelectedDateTime).format('MMMM D, YYYY HH:mm');
};
